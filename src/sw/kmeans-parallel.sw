...
for (i in range(0, num_partitions)){ 
    points = points + [spawn_exec("java", {"inputs":[], "lib":java_lib, "class":"tests.kmeans.KMeansInitialPoints", "argv":[1000, 10]}, 1)[0]];
}

new_centroids = spawn_exec("java", {"inputs":[], "lib":java_lib, "class":"tests.kmeans.KMeansInitialPoints", "argv":[10, 10]}, 1)[0];
