...
import skyhout.common.OutputCollector;
import skyhout.common.PartialHashOutputCollector;
...
public class KMeansMapTask implements Task {
	...
	public void invoke(InputStream[] fis, OutputStream[] fos,
		...
		try {
			...
			PartialHashOutputCollector<Text, KMeansInfo> output = new PartialHashOutputCollector<Text, KMeansInfo>(mapOutputs, Integer.MAX_VALUE, new skyhout.kmeans.KMeansCombiner());
