...
# WORDCOUNT benchmark in C for given parameters.
#
# usage: run-wordcount-c.sh after editing parameters
...
for i in 1 2 3 4 5; do
    ...
    time $SWROOT/scripts/sw-job -m $MASTER -e $SWROOT/src/sw/wordcount-c.sw 2>&1
done
