...
function restart {
    ...
    sleep 3
    EXTRA_ARGS="-j /opt/skywriting/journal -S" scripts/sw-launch-cluster -f ~/hostnames-20.txt -i ~/key
...
do
    ...
    exp_filename=auto-results/micro-single-yieldjournal-$i.txt
	...
	JOB_ID=`scripts/sw-submit src/package/test_scala_chainyield.pack 1 5000 ChainYieldTest`
	echo $exp_filename
