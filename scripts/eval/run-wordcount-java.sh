...
# WORDCOUNT benchmark in Java for given parameters.
#
# usage: run-wordcount-java.sh after editing parameters
...
for i in 1 2 3 4 5; do
    ...
    time $SWROOT/scripts/sw-job -m $MASTER -e $SWROOT/src/sw/wordcount.sw 2>&1
done
