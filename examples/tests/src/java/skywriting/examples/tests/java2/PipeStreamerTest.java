...
public class PipeStreamerTest implements FirstClassJavaTask {
	...
	public void invoke() throws Exception {
		...
		FirstClassJavaTask producer = new PipeStreamerProducer(67108864, n_chunks, may_stream, producer_pipe);
		Reference[] producer_refs = Ciel.spawn(producer, new String[0], 2);
	    FirstClassJavaTask consumer = new PipeStreamerConsumer(67108864, producer_refs[1], may_stream, consumer_pipe, consumer_must_block, do_log);
